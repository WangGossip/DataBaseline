...
def get_model(model_name):
    ...
    # -这是一个小型的，通道数都减少为1/4
        ...
        return WideResNet(28,10,10,0.4)
...
class WideResNet(nn.Module):
    def __init__(self, depth, num_classes=10, widen_factor=1, dropRate=0.0, num_hide = 128):
        ...
        self.fc1 = nn.Linear(nChannels[3], num_hide)
        self.fc2 = nn.Linear(num_hide, num_classes)
